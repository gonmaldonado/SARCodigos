<%@ Page Title="Seat" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SARcodigos._Default" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      <ContentTemplate>
       <h1><span class="label label-default">Seat</span></h1> 
      <div class="col-md-6">
   ...
   <ContentTemplate>
     ...
     <h3><span class="label label-default">Filtrar</span></h3> 
        <div class="col-md-8">
            ...
            <div style="width: 90px; height: 165px">
                <asp:CheckBoxList ID="cbTipo" runat="server"></asp:CheckBoxList>
            </div>
                    </td>
                    <td>
            <asp:Label ID="Label3" runat="server" Text="Vehiculo:"></asp:Label>
            <div class="scrolling-table-container" style="width: 90px; height: 165px">
                <asp:CheckBoxList ID="cbVehiculo" runat="server"></asp:CheckBoxList>
            </div>
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td>
            ...
            <div class="scrolling-table-container" style="width: 110px; height: 165px">
            ...
            <div style="width: 110px; height: 165px">
    ...
    <div class="col-md-4">
        <table>
           <td>
              <asp:Label ID="Label11" runat="server" Text="Airbag:"></asp:Label>
                <div style="width: 90px; height: 165px">
                 <asp:CheckBoxList ID="cbAirbag" runat="server">
            ...
            <td>
               <asp:Label ID="Label12" runat="server" Text="Heater:"></asp:Label>
               <div style="width: 90px; height: 165px">
                  <asp:CheckBoxList ID="cbHeater" runat="server">
                   <asp:ListItem>SI</asp:ListItem>
                   <asp:ListItem>NO</asp:ListItem>
                   </asp:CheckBoxList>
                </div>

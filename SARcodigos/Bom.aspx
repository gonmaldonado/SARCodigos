<%@ Page Title="Bom" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Bom.aspx.cs" Inherits="SARcodigos.Bom" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      <ContentTemplate>
       <h1><span class="label label-default">Bom</span></h1> 
      <div class="col-md-6">
   ...
   <ContentTemplate>
     ...
     <h3><span class="label label-default">Filtrar</span></h3> 
        <div class="col-md-9">
            ...
            <div class="scrolling-table-container" style="width: 180px; height: 165px">
  ...
  <td>
            ...
            <div class="scrolling-table-container" style="width: 90px; height: 165px">
                <asp:CheckBoxList ID="cbCantidad" runat="server"></asp:CheckBoxList>
            </div>
            </td>
                    <td>&nbsp;&nbsp;&nbsp;</td>

            <td>
            <asp:Label ID="Label1" runat="server" Text="UM:"></asp:Label>
            <div style="width: 100px; height: 165px">
                <asp:CheckBoxList ID="cboUM" runat="server"></asp:CheckBoxList>
            </div>
            </td>
          </tr>
   </table>
